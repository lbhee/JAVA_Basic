...
// for 반복문
// for 반복문은 while 반복문에 비해 비교적 횟수가 명확하다.
...
public class Ex01For1 {
    public static void main(String[] args) {
        ...
        // 3. System.out.printf() 실행
        // 4. i++ -> i는 2가 된다.
        // 5. i <= 3 -> i의 현재값이 2이므로 true
        // 6. System.out.printf() 실행
        // 7. i++ -> i는 3이 된다.
        // 8. i <= 3 -> i는 3이 된다.
        // 9. System.out.printf() 실행
        // 10. i++ -> i는 4가 된다.
        // 11. i <= 3 -> i의 현재값이 4이므로 false
        // 12. for문이 종료된다.
           
        // 2번. 제어변수의 초기화나 조건식에는 다른 변수가 사용가능하다.
        ...
        // 3번. 비록 우리가 "전통적으로" 제어변수는
        // i -> j -> k -> l 이런식으로 들어가지만
        // 불편하다면 굳이 제어변수의 이름을 i라고 안해줘도 된다.
        // 조건식과 변화식은 주로 뭐보다 작을동안, ++ 을 쓰지만
