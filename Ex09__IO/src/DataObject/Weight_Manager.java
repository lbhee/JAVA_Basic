...
public class Weight_Manager {
    ...
    File f;
    File fd= new File("C:\\Temp2\\WeightMgData/"); //파일이 생성될곳
 ...
 public void inputWeight() throws IOException{
        ...
        File f= new File("C:\\Temp2\\WeightMgData/"+this.str_name+".txt"); //기록할 파일객체 생성
        ...
        if( !f.exists()){      
            ...
            bw.close();
            System.out.println("___입력이 완료되어_..[ C:\\Temp2\\WeightMgData/"+this.str_name+".txt ]._가(이) 생성되었습니다.");
        }else{
